...
def main():
    ...
    vae = AutoencoderKL.from_pretrained("newvae", torch_dtype=torch_dtype)
    # 加载SDXL管道
    ...
    pipe.load_lora_weights("AiWise/RealisticPortrait-MidjourneyMimic-SDXL-LoRA-v1-RVXLv4-Baked-VAE")
