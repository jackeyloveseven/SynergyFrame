...
class MultiScaleDepthEnhancement:
    ...
    def _compute_gradient_features(self, depth):
        ...
        grad_direction = (grad_direction + np.pi) / (2 * np.pi)  # 归一化到 [0,1]
        ...
        return combined_features.astype(np.uint8)
...
class DirectionalShadingModule:
    ...
    def __init__(self, 
                 ...
                 normal_smooth_kernel=(5, 5),
                 normal_smooth_sigma=1.0):
        """
